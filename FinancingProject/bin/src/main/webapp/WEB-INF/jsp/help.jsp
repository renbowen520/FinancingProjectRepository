    ...
    <div class="row">
        <div class="left">
            ...
            <div class="item" name="securities" id="securitiesTab">
             ...
             <div class="item" name="aboutUs" id="aboutUsTab">
              关于我们
            </div>
            
            <div class="blank" style=" height: 1226.4px; ">
        ...
        <div class="right">
            ...
            <div class="content" id="aboutUs">
                ...
                <div class="first desc">
                    孔明理财于2017年正式上线，是一家专业的第三方互联网金融平台。公司由一批具有创业热情的互联网以及金融行业内的精英组成。团队主要成员来自于奇虎360、腾讯、新浪微博、惠普、微软、赶集网、中金等国内知名互联网和金融企业，已拿到梅花创投的500万元天使投资。<br><br>
                    ...
                    孔明理财坚信，凭借其卓越的团队，独特的经济视角，丰富的风险控制经验，会在未来，不断的为用户创造更高的价值。
                </div>
                <div class="point">
                    联系我们
                </div>
                <div class="desc">
                    尊贵热线：400-888-888<br><br>
                    QQ邮箱：2060142983@qq.com<br><br>
                    公司地址：襄阳市襄城区长虹路汉水华城写字楼20层<br><br>
                    <br><br><br><br>
                </div>
            </div>
            ...
            <div class="content" id="securities">
                ...
                <div class="desc">
                    <div class="desc">
                        如果您对盈+理财网站操作流程不太熟悉，
                        请参考为您制作的网站操作流程指引：
                        <button class="btn" onClick="location.href='/FinancingProject/IndexController/register'">我来给您带路！</button>
                    </div>
                </div> 
            </div>
