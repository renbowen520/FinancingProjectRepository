...
<div class="error_new_bg pr">
	<div class="error_new_content">
		<div class="error_new pa">
			<div class="fl error_new_left"><img src="/FinancingProject/images/error-1.png"></div>
			<div class="fl error_new_right">
				<p class="mb15"><img src="/FinancingProject/images/error-2.png"></p>
				<p class="error_new_right_btn pr">
					<a href="/FinancingProject/index.jsp" class="type-2 type-3">
						<i> 返回首页</i>
						<i> 返回首页 </i>
						<i> 返回首页 </i>
						<i> 返回首页 </i>
