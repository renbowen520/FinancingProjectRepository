...
<link href="/FinacingProjects/css/iconfont.css" rel="stylesheet" type="text/css">
<link href="/FinacingProjects/css/common.css" rel="stylesheet">
<link href="/FinacingProjects/css/jw2.css" rel="stylesheet">

<script src="/FinacingProjects/js/hm.js"></script>
<script src="/FinacingProjects/js/jquery.js"></script>
<script type="text/javascript" src="/FinacingProjects/js/layer.js"></script>
<link rel="stylesheet" href="/FinacingProjects/css/layer.css" id="layui_layer_skinlayercss">
<script src="/FinacingProjects/js/echarts.js"></script>    
<link href="/FinacingProjects/css/jquery.fancybox-1.3.4.css" rel="stylesheet">
    <script src="/FinacingProjects/js/jquery.fancybox-1.3.4.js"></script>
...
<div style="width: 1002px; height: 94px; margin: 0 auto;">
		<iframe src="/FinacingProjects/top" scrolling="nox`" width="1002"
			...
			<div class="row">
				<ul class="topNav">
					...
					<li class="active"><a class="item first"
						href="/FinacingProjects/home"> 首页 </a></li>
					<li><a class="item" href="/FinacingProjects/exploration">
							网上体验中心 </a></li>
					<li><a class="item" href="/FinacingProjects/product"> 产品中心 </a>
					</li>
					<li><a class="item"
						href="/FinacingProjects/frontJournalism"> 新闻中心 </a></li>
					<li><a class="item"
						href="/FinacingProjects/frontLoad"> 下载中心 </a></li>
					<li><a class="item " href="/FinacingProjects/frontCollege">
							盈+商学院 </a></li>
					<li><a class="item"
						href="/FinacingProjects/frontStudy"> 投研中心
					</a></li>
					<li><a class="item last"
						href="/FinacingProjects/myadd">
							我的加法库 </a></li>
				</ul>
			</div>
		</div>
...
<p>本产品是中建投信托产品，上市公司宋都股份为该项目项下宋都集团的债务清偿提供连带责任保证责任，宋都股份为A股上市公司，浙江本地较大房地产企业，综合实力较强；</p><p>标的项目为杭州市区内刚需楼盘，销售情况较好；还款来源充足。</p><p>抵押物位于杭州桐庐大奇山郡未售现房，品质较高，抵押率不超过50%，抵押资产真实可靠。</p></div></div></div><div class="listItem row_2"><div class="media"><span class="fr"><em class="detailIcon">&nbsp;</em></span><div class="media-body"><h3>钱去哪了</h3><p>本产品由债权出让人购得中建投信托-安泉19号集合资金信托计划，用于宋都集团下属子公司香悦郡置业负责开发的杭州宋都香悦郡项目的开发建设。</p></div></div></div><div class="listItem row_3"><div class="media"><span class="fl"><em class="detailIcon">&nbsp;</em></span><div class="media-body"><h3>购买准备</h3><p>1. 首次购买需开通理财账户，理财账户可直接进行充值。</p><p>2. 了解申购所用银行卡支持情况，大额支付需要网银，支持银行数量和支付限额高；快捷支付方便迅速，但支持银行数量有限。</p><p>3. &nbsp;产品限量抢购，提前充值可以大大提升抢购成功率。</p></div></div></div><div class="listItem row_4"><div class="media"><span class="fr"><em class="detailIcon">&nbsp;</em></span><div class="media-body"><h3>怎样赎回</h3><p>产品到期后本金和收益将自动回款至您的理财账户，产品到期前暂不支持提前赎回。</p></div></div></div><div class="tipRow f12 g9">由于理财资金管理运用过程中，可能会面临多种风险因素，在您选择购买本理财产品前，请充分认识风险，谨慎投资</div></div></div></div>
    ...
    <div class="picList">
        认证文件展示
        <ul>
            <li><a href="/FinacingProjects/img/1442455557145.png"><img src="/FinacingProjects/img/1442455557145.png"></a></li>
            <li><a href="/FinacingProjects/img/1442455557158.png"><img src="/FinacingProjects/img/1442455557158.png"></a></li>
            <li><a href="/FinacingProjects/img/1442455557162.png"><img src="/FinacingProjects/img/1442455557162.png"></a></li>
            <li><a href="/FinacingProjects/img/1442455557165.png"><img src="/FinacingProjects/img/1442455557165.png"></a></li>
        </ul>
    ...
    <div class="container index">
			<div class="row">
				<div class="security">
					<div class="item">
						<img src="/FinacingProjects/img/indexSecurity1.png">
						<div class="detail">
							资金银行监管
					...
					<div class="item">
						<img src="/FinacingProjects/img/indexSecurity2.png">
						<div class="detail">
							交易证监会监管
					...
					<div class="item">
						<img src="/FinacingProjects/img/indexSecurity3.png">
						<div class="detail">
							风控盈+监管
					...
					<ul style="margin-bottom: 0px;" class="ft_sns_list clearfix">
						<li>
							<div class="wx_tips j_tips">
								...
								<div class="tips_bd">
									<em class="arrow"></em> <img src="/FinacingProjects/img/yj.jpg"
										alt="微信公共平台">
								</div>
							</div>
						</li>
					...
					<div class="contactUs">
						...
						<div class="contactInfo" style="padding-left: 30px;">
							<a
								...
								src="/FinacingProjects/img/qqIcon.png"
