...
<div class="countBox">
    <ul>
        ...
        ${member_account.imuseale_balance }</h2><p>投资金额(元)<a href="javascript:;" class="iconfont"><span>投资中资金</span><i></i></a></p></li>
...
<div class="adminLeft">
	...
	<table class="tzlist" width="100%" border="1" bordercolor="#e9e9e9" cellspacing="0" cellpadding="0">
		...
		<c:forEach items="${chongzhi_list }"  var="s"  varStatus="var">
		  <tr>
	...
	<div class="listCount">总计<font color="#ff503f">${fn:length(chongzhi_list)} </font>笔</div>
</div>
